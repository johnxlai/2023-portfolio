...
const Navbar = () => {
  return (
    <nav className="navbar">
      <div className="container flex justify-between items-center px-4 xl:px-0">
        ...
        <ul className="nav-menu hidden lg:flex gap-3 text-primary uppercase font-bold font-roboto">
          {NavItems.map((item) => (
            <li key={item.id}>
